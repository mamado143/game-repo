/* Requirements:
 1. Ask for how many rounds the game will be.
  2.Start each round Player vs Computer.
  3.Show the results with each round.
4. If computer wins the round ring a bill, and make the screen red.
 5. If player won the round show green screen.
 6.After all rounds show game over the print game results, then ask the user if s/he wants to play again? */
#include <iostream>
#include <cstdlib>
using namespace std;
enum enGameChoice
